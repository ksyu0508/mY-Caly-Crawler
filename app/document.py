...
Select the type from the following categories:
...
Start time: 00:00:00
End time: 23:59:59
4.Output Structure: Return the information in the following JSON format:
{"type": "<selected_type>", "tags": [<list_of_selected_tags>], "startAt": "<start_datetime>", "endAt": "<end_datetime>"}
'''
...
async def perform_llm(question: str):
